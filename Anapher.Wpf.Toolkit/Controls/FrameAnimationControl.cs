...
namespace Anapher.Wpf.Toolkit.Controls
{
    public class FrameAnimationControl : ContentControl
    {
        public static readonly DependencyProperty FrameResourceNameProperty =
            DependencyProperty.Register("FrameResourceName", typeof(string), typeof(FrameAnimationControl),
