...
namespace Anapher.Wpf.Toolkit.StatusBar
{
    ...
    public static class ShellStatusBarExtensions
    {
        ...
        /// <summary>
        ///     Display a status on a <see cref="IShellStatusBar"/> while a <see cref="Task{T}"/> is running. To avoid flickering in case the task executes very fast, the message isn't shown immediately and will be visible for at least one second.
        /// </summary>
