...
namespace Anapher.Wpf.Toolkit.Windows
{
    ...
    public interface IWindowService : IWindowInteractionService
    {
        ...
        /// <returns>
        ///     A <see cref="Nullable{T}" /> value of type Boolean that specifies whether the activity was accepted (
        ///     <code>true</code>) or canceled (<code>false</code>). The return value is the value of the DialogResult property
        ///     before a window closes.
        /// </returns>
        bool? ShowDialog(Type viewModelType, Action<IUnityContainer> configureContainer,
        ...
        /// <param name="configureViewModel">Configure the view model</param>
        /// <param name="viewModel">Get the created view model</param>
        void Show(Type viewModelType, Action<IUnityContainer> configureContainer, Action<IShellWindow> configureWindow,
            Action<object> configureViewModel, out object viewModel);
    }
}