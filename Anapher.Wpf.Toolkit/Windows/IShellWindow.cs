...
namespace Anapher.Wpf.Toolkit.Windows
{
    ...
    public interface IShellWindow : IWindow
    {
        ...
        /// <summary>
        ///     Gets or sets the task bar icon. If <see cref="TitleBarIcon" /> is null, the title bar icon will also be set to the
        ...
        /// <param name="statusBarManager">
        ///     The status bar manager. If this value is <code>null</code>, no status bar will be
        ///     created.
        /// </param>
        ...
        ///     <code>true</code>) or canceled (<code>false</code>). The return value is the value of the
